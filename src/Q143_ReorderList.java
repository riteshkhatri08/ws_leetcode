public class Q143_ReorderList {
    public static void main(String[] args) {
        ...
        new Q143_ReorderList().new Solution().reorderList(head);
    ...
    private static void addNodes(Q143_ReorderList obj, Q143_ReorderList.ListNode head,
            int[] arr) {
        ListNode temp;
        for (int val : arr) {
    ...
    public String print(Q143_ReorderList.ListNode head) {
